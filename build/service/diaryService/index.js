...
exports.addEntries = exports.findById = exports.getSensitiveEntries = exports.getEntries = void 0;
...
const addEntries = (newDiary) => {
    const newDiaryEntry = Object.assign({ id: diaries.length + 1 }, newDiary);
